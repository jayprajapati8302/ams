        ...
        <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="nav-link" href="Response-to-contract.php">Response to Service Request</a></li>
                <li><a class="nav-link" href="service-contract.php">Service Contract</a></li>
