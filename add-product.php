...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
  ...
  $sql = "INSERT INTO add_product (p_name, p_price) VALUES ('$p_name', '$p_price')";
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <input type="text" id="p_name" name="p_name" class="form-control" placeholder="Product Name">
                    </div>
                    <div class="form-group">
                      <label>Product Price</label>
                      <input type="text" id="p_price" name="p_price" class="form-control" placeholder="Product Price">
                    </div>
                  </div>
