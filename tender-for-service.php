...
$sql = mysqli_query($conn, "SELECT * FROM pincode_detail");
?>
<!DOCTYPE html>
<html lang="en">
            ...
            <li class="dropdown">
              ...
              <li class="menu-header">Technician Profile</li>
                ...
                <ul class="dropdown-menu">
                    ...
                    <li><a href="technician-contracts.php">Technician Contracts</a></li>
              ...
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                  <div class="card-header">
                    <h4>Tender for service Detail</h4>
                  </div>
                  <div class="card-body">
                    <div class="form-group">
                      ...
                      <select class="form-control">
                        ...
                        if (mysqli_num_rows($sql) > 0) {
                          ...
                          echo "<option value=''>No pincodes found</option>";
                        }
                        ?>
                      </select>
                      <?php
                      ...
                      <div class="form-group">
                      <form method="POST" action="s_type.php">
                      <label>Service type</label>
                      <input type="text" id="s_type" name="s_type" class="form-control" placeholder="Service type">
                    </div>
                    </div>
                  </div>
                  <div class="card-footer text-right">
                    <button class="btn btn-primary mr-1" type="submit" name="add_product">Submit</button>
                  </div>
                </div>
        </div>
